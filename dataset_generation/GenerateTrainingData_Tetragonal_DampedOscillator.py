...
def check_folder_exist(folder, input_group):
    """
    Create folders if missing to insert data into
    """
    ...
    return savefolder, imagefolder

folder = curr_dir

f = open("%s/metaTet.txt"%curr_dir,"w")
...
for g in [0,1,2,4]:
    ...
    savefolder, imagefolder = check_folder_exist(folder, g)
