...
def prep_dataset(directory, molcode, artefact_folder="/path/to/unzipped/Artefacts/", wasserstein_cutoff=6.7E-11):
    """
    ...
    for x, file in enumerate(sorted(dir_files)):
        ...
        wass_dist = []
        for i in range(scat_data_norm.size()[-1]):   #Runs on top triangle of data 
    ...
    # normalise between 0 and 1 instead 
...
def main(molcode, readfolder="/path/to/save/location/dataset/raw_files/", savefolder="/path/to/training/dataset/training/", artifactfolder="/path/to/unzipped/Artefacts/"):
    """
    Generate training / validation data

    NOTE FOR USERS: If you are using the tetragonal or hexagonal codes, you will need to swap the a/b/c and qmax/m1 etc. commented lines for the meta data to correctly propagate through
    ...
    # Save as images instead of numpy arrays (NOT RECOMMENDED because of memory)
    """
